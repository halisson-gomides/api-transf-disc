...
async def consulta_convenio(
    ...
    subsituacao_conv: Literal['Convênio', 'Convênio Cancelado', 'Convênio Encerrado', 'Proposta', 'Em aditivação'] = Query(None, description='Subsituação do Convênio'),
    situacao_publicacao: Literal['Publicado', 'Transferido para IN'] = Query(None, description='Situação atual da Publicação do instrumento'),
    instrumento_ativo: Literal['SIM', 'NÃO'] = Query(None, description='Indica se o instrumento está ativo'), 
    ind_opera_obtv: Literal['SIM', 'NÃO'] = Query(None, description='Indicativo de que o Convênio opera com OBTV'),
    ...
    situacao_contratacao: Literal['Cláusula Suspensiva', 'Liminar Judicial', 'Normal', 'Sob Liminar Judicial e Cláusula Suspensiva'] = Query(None, description='Situação atual da Contratação'),
    ind_assinado: Literal['SIM', 'NÃO'] = Query(None, description='Indica se o convênio está assinado'), 
    ...
    ind_foto: Literal['SIM', 'NÃO'] = Query(None, description='Indicador se o Convênio possui Foto'), 
